...
ActiveRecord::Schema.define(version: 2019_10_12_131030) do
  ...
  create_table "declension_names", force: :cascade do |t|
    ...
    t.index ["person_id"], name: "index_declension_names_on_person_id"
  end
  ...
  add_foreign_key "declension_names", "people"
end
